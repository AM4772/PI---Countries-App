...
export function getCountryById(id) {
  // it fetches a country by country code
  return async (dispatch) => {
    try {
...
export function getCountryActivities() {
  // it fetches all countries along with their associated activities
  return async (dispatch) => {
    try {
...
export function getActivities() {
  // returns all activities in the activity table, used in the filter
  return async (dispatch) => {
    try {
...
export function postActivity(payload) {
  // it creates a new activity and associates it with a country
  return async () => {
    try {
...
export function deleteActivity(payload) {
  // it deletes an activity and its associations
  return async () => {
    try {
